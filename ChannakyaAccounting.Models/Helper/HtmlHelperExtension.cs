...
namespace ChannakyaAccounting.Models.Helper
{
    public static class HtmlHelperExtension
    {
        ...
        public static MvcHtmlString EditorForTree<TModel, TValue>(this HtmlHelper<TModel> html, Expression<Func<TModel, TValue>> propertyExpression, ChannakyaAccounting.Models.ViewModel.TreeViewParam param
            ...
            ) where TModel : class
        {
            ...
            htmlBuilder.AppendFormat(@"<input type='text' name='display-txt' class='form-control display-txt' value=""{0}"" id=""{1}"" placeholder='Search...' style='max-width:1000px;'>", valueText, htmlFieldIdWithPrefix);
        ...
        public static MvcHtmlString EditorForEmployeeSearch<TModel, TValue>(this HtmlHelper<TModel> html, Expression<Func<TModel, TValue>> propertyExpression, ChannakyaAccounting.Models.ViewModel.SearchViewModel searchParam) where TModel : class
        {
