...
namespace ChannakyaAccounting.Models.ViewModel
{
    ...
    public class AccountingTreeDTO
    {
        public AccountingTreeDTO()
        {
            PId = null;
            Image = null;
            IsGroup = true;
        ...
        public bool IsChecked { get; set; }
        public List<ViewModel.TreeDTO> Children { get; set; }
        public List<ViewModel.AccountingTreeDTO> AccChildren { get; set; }
    }
    ...
    public class TreeView
    {
        public TreeView()
        {
            ...
            AccChildren = new List<ViewModel.AccountingTreeDTO>();
            Title = "Treeview";
        }
